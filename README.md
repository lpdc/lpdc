...
...
(Default kernel)
submenu 'Advanced options for Ubuntu' $menuentry_id_option **Bold**'gnulinux-advanced-b5b06d70-ea98-45ab-be8a-55b2fcec9baf'**Bold** {
...
(MPTCP kernel)
menuentry 'Ubuntu, with Linux 4.19.105+' --class ubuntu --class gnu-linux --class gnu --class os $menuentry_id_option **Bold**'gnulinux-4.19.105+-advanced-b5b06d70-ea98-45ab-be8a-55b2fcec9baf'**Bold**
...
```
